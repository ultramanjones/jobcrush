...
bool FormattedDocumentWriter::writeWordDocument(const QString &markdownText,
...
bool FormattedDocumentWriter::writePortableDocument(const QString &markdownText,
                                            const QString &filePath,
                                            QString &reasonText) const
{
